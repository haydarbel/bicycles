...
public class JpaDocentRepository implements DocentRepository {
    ...
    public List<IdEnEmailAdres> findIdsEnEmailAdressen() {
        return manager.createQuery("select new be.vdab.fietsen.projections.IdEnEmailAdres(d.id,d.emailAdres)from Docent d",
    ...
    public List<AantalDocentenPerWedde> findAantalDocentenPerWedde() {
        return manager.createQuery("select new be.vdab.fietsen.projections.AantalDocentenPerWedde(d.wedde,count(d))" +
